            ...
            "data": [
                {
                    ...
                    "itineraries": [
                        {
                            "segments": [
                                {"departure": {"iataCode": origin_city_code, "at": from_time.strftime("%Y-%m-%dT10:00")},
                                 "arrival": {"iataCode": destination_city_code, "at": from_time.strftime("%Y-%m-%dT14:00")}}
                            ]
                        },
                        {
                            "segments": [
                                {"departure": {"iataCode": destination_city_code, "at": to_time.strftime("%Y-%m-%dT16:00")},
                                 "arrival": {"iataCode": origin_city_code, "at": to_time.strftime("%Y-%m-%dT20:00")}}
                            ]
                        }
                    ]
                }
